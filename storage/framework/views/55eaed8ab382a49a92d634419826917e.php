...
<head>
    ...
    <style>
        ...
        body{
            ...
            url('<?php echo e(asset('img/bg.jpg')); ?>') no-repeat center center fixed;
...
<a href="<?php echo e(route('mahasiswas.create')); ?>" class="btn btn-primary btn-sm">
...
<a href="<?php echo e(route('mahasiswas.edit',$mhs->id)); ?>"
...
<form action="<?php echo e(route('mahasiswas.destroy',$mhs->id)); ?>"
method="POST"
class="d-inline">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/mahasiswa-app/resources/views/mahasiswas/index.blade.php ENDPATH**/ ?>